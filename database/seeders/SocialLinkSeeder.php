...
class SocialLinkSeeder extends Seeder
{
    public function run(): void
    {
        $links = [
            [
                'platform' => 'Instagram',
                'url'      => 'https://instagram.com/dotech.id',
            ...
            [
                'platform' => 'LinkedIn',
                'url'      => 'https://linkedin.com/company/dotech',
