        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
            <div class="text-center">
                ...
                <h1 class="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-extrabold text-white leading-tight mb-6 animate-fade-in-up">
                    <span class="bg-gradient-to-r from-blue-400 via-cyan-400 to-blue-500 bg-clip-text text-transparent">Proyek</span> Kami
                </h1>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-10 hover:shadow-md transition">
            <form method="GET" class="flex flex-col md:flex-row gap-4">
                ...
                @if($term)
                <a href="{{ route('projects.index') }}" class="btn-outline px-6 py-3 flex items-center justify-center gap-2">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="group bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-dotech-blue/20 transform hover:-translate-y-1">
                <a href="{{ route('projects.show', $project->slug) }}" class="block">
                    {{-- Image Container --}}
                    <div class="relative overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200 aspect-video">
                        ...
                        <div class="absolute top-3 left-3">
                            <span class="bg-dotech-blue/90 backdrop-blur-sm text-white text-xs font-medium px-3 py-1.5 rounded-full shadow-lg">
                        ...
                        <div class="absolute bottom-3 right-3 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0">
                            <span class="bg-white text-dotech-blue rounded-full w-9 h-9 flex items-center justify-center shadow-lg hover:scale-110 transition">
                    ...
                    {{-- Content --}}
                    <div class="p-5">
                        <h2 class="font-bold text-xl text-gray-900 mb-2 group-hover:text-dotech-blue transition-colors line-clamp-1">
                            {{ $project->title }}
                        </h2>
                        ...
                        <div class="flex flex-wrap gap-2 mb-4">
                            ...
                            <span class="text-xs text-gray-400">+{{ count($project->technologies) - 3 }}</span>
                            @endif
                        </div>
                        @endif
                        ...
                        <div class="flex items-center justify-between pt-3 border-t border-gray-100">
                            <div class="flex items-center gap-1.5">
                                ...
                                <span class="text-xs text-gray-500">{{ $project->client_name ?? 'Confidential' }}</span>
                            </div>
                            <div class="flex items-center gap-1.5">
                                <i class="fas fa-calendar-alt text-gray-400 text-xs"></i>
                                <span class="text-xs text-gray-400">{{ $project->project_date?->format('M Y') ?? 'Recent' }}</span>
                            </div>
                        </div>
                    </div>
                </a>
        ...
        <div class="text-center py-20 bg-gray-50 rounded-3xl">
            ...
            @if($term)
            <a href="{{ route('projects.index') }}" class="inline-flex items-center gap-2 mt-6 text-dotech-blue hover:text-blue-700 font-medium">
