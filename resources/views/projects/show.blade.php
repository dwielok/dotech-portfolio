...
<div class="pt-20">
    ...
    <div class="relative bg-gradient-to-br from-dotech-dark via-blue-900 to-blue-950 text-white overflow-hidden">
        ...
        <div class="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
            ...
            {{-- Category Badge --}}
            @if($project->category)
            <div class="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-4 py-1.5 mb-5 animate-slide-down animation-delay-100">
    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div class="lg:col-span-2">
                ...
                <div class="group relative mb-8 overflow-hidden rounded-2xl shadow-xl bg-gray-100">
                    <img src="{{ $project->featured_image_url }}" alt="{{ $project->title }}"
                         ...
                         onclick="window.open('{{ $project->featured_image_url }}', '_blank')"
                         loading="lazy">
                    <div class="absolute bottom-3 right-3 opacity-0 group-hover:opacity-100 transition">
                        <span class="bg-black/50 backdrop-blur-sm text-white text-xs px-2 py-1 rounded-lg">
                            <i class="fas fa-expand-alt text-[10px] mr-1"></i> Klik untuk zoom
                        </span>
                    </div>
                </div>
                ...
                <div class="mt-12">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <a href="{{ $image->image_url }}" target="_blank" class="group overflow-hidden rounded-xl bg-gray-100 hover:shadow-lg transition">
                ...
                <div class="mt-12 grid md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-amber-50 rounded-xl p-5 border-l-4 border-amber-500 hover:shadow-md transition">
                    ...
                    @endif
                    @if($project->solution)
                    <div class="bg-green-50 rounded-xl p-5 border-l-4 border-green-500 hover:shadow-md transition">
                        <div class="flex items-center gap-2 mb-3">
            ...
            <div class="space-y-6">
                {{-- Project Info Card --}}
                <div class="bg-white rounded-2xl shadow-md border border-gray-100 p-6 space-y-5 hover:shadow-lg transition">
                    ...
                    <div class="flex items-start gap-3 group">
                        <i class="fas fa-building text-gray-400 w-5 mt-0.5 group-hover:text-dotech-blue transition"></i>
                        <div>
                    ...
                    @if($project->project_date)
                    <div class="flex items-start gap-3 group">
                        <i class="fas fa-calendar-alt text-gray-400 w-5 mt-0.5 group-hover:text-dotech-blue transition"></i>
                        <div>
                    ...
                    @if($project->category)
                    <div class="flex items-start gap-3 group">
                        <i class="fas fa-folder text-gray-400 w-5 mt-0.5 group-hover:text-dotech-blue transition"></i>
                        <div>
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap gap-2">
                            ...
                            <span class="inline-flex items-center gap-1 text-xs bg-gradient-to-r from-blue-50 to-indigo-50 text-blue-700 px-3 py-1.5 rounded-full hover:from-blue-100 hover:to-indigo-100 transition">
                ...
                {{-- CTA Card --}}
                <div class="relative bg-gradient-to-br from-dotech-dark to-blue-900 text-white rounded-2xl p-6 overflow-hidden group hover:shadow-xl transition">
                    <div class="absolute top-0 right-0 w-32 h-32 bg-blue-500/20 rounded-full blur-2xl group-hover:scale-150 transition duration-700"></div>
                    <div class="relative">
                        <div class="inline-flex items-center justify-center w-12 h-12 bg-white/10 rounded-xl mb-4 group-hover:scale-110 transition">
                            <i class="fas fa-handshake text-xl text-white"></i>
                        </div>
                        <h3 class="font-bold text-xl mb-2">Punya Proyek Serupa?</h3>
                        <p class="text-sm text-blue-100 mb-5 leading-relaxed">Hubungi kami dan diskusikan kebutuhan digital Anda dengan tim ahli kami.</p>
                        <a href="{{ route('contact') }}" class="inline-flex items-center justify-center w-full gap-2 bg-white text-dotech-blue font-semibold px-5 py-3 rounded-xl hover:bg-gray-100 transition group">
                ...
                <div class="bg-gray-50 rounded-2xl p-5 hover:shadow-md transition">
                    ...
                    <div class="flex gap-3">
                        ...
                        <a href="https://twitter.com/intent/tweet?text={{ urlencode($project->title) }}&url={{ urlencode(url()->current()) }}" target="_blank"
        ...
        <div class="mt-16 pt-8 border-t border-gray-100">
            <div class="flex items-center justify-between mb-8">
                ...
                <a href="{{ route('projects.index') }}" class="text-sm text-dotech-blue hover:text-blue-700 flex items-center gap-1 group">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <a href="{{ route('projects.show', $p->slug) }}" class="group bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 hover:-translate-y-1">
                    ...
                    <div class="p-4">
                        ...
                        <h3 class="font-bold text-gray-900 group-hover:text-dotech-blue transition-colors line-clamp-1">
                            {{ $p->title }}
                        </h3>
                        @if($p->client_name)
