...
@section('content')
    ...
    <section
        class="relative min-h-[60vh] flex items-center overflow-hidden bg-gradient-to-br from-dotech-dark via-blue-950 to-dotech-dark">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28 text-center">
            {{-- Animated Badge --}}
            <div
                class="inline-flex items-center gap-2 bg-dotech-blue/20 backdrop-blur-sm border border-dotech-blue/30 rounded-full px-4 py-1.5 mb-6 animate-slide-down">
            ...
            <h1
                ...
                @else
                    <span
                        class="bg-gradient-to-r from-blue-400 via-cyan-400 to-blue-500 bg-clip-text text-transparent">Mengenal</span>
                    Lebih Dekat
                @endif
            </h1>
            ...
            {{-- Description --}}
            <p
                class="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed animate-fade-in-up animation-delay-200">
                @if ($about && $about->hero_description)
                    {{ $about->hero_description }}
                @else
                    Kami adalah mitra transformasi digital yang berkomitmen menghadirkan solusi teknologi inovatif untuk
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div class="relative">
                        ...
                        @else
                            <div
                                class="relative bg-gradient-to-br from-dotech-blue to-blue-700 rounded-2xl shadow-2xl w-full min-h-[400px] flex items-center justify-center">
                        ...
                        <div class="prose prose-lg text-gray-600 space-y-4">
                            ...
                            @else
                                <p>PT Dotech Digital Solution berdiri sejak tahun 2016 dengan visi menjadi perusahaan
                                    ...
                                    signifikan.</p>
                                <p>Dengan tim yang berpengalaman di berbagai bidang teknologi, kami telah membantu lebih
                                    dari 150+ klien dari berbagai industri untuk mencapai tujuan digital mereka. Komitmen
                                    kami adalah memberikan solusi yang tidak hanya canggih secara teknis, tetapi juga
                                    relevan dengan kebutuhan bisnis klien.</p>
                                <p>Sampai saat ini, kami terus berinovasi dan berkembang mengikuti perkembangan teknologi
                                    global, sambil tetap memegang teguh nilai-nilai integritas, kolaborasi, dan dampak
                                    positif.</p>
                            @endif
                        </div>
    ...
    <section class="py-20 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <span class="bg-dotech-blue/10 text-dotech-blue text-sm font-semibold px-4 py-1.5 rounded-full">Core
                    Values</span>
                <h2 class="text-3xl lg:text-4xl font-bold text-gray-900 mt-4">Prinsip Yang Mendasari Setiap Langkah Kami
                </h2>
                <p class="text-gray-600 mt-3 max-w-2xl mx-auto">Nilai-nilai yang menjadi fondasi dalam setiap proyek dan
                    kolaborasi bersama klien</p>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {{-- Innovation Card --}}
                <div class="bg-white rounded-2xl p-6 text-center shadow-sm hover:shadow-md transition group">
                    <div
                        class="w-16 h-16 bg-gradient-to-br from-blue-500 to-dotech-blue rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition duration-300">
                        <i class="fas fa-lightbulb text-white text-2xl"></i>
                    </div>
                    <h3 class="text-xl font-bold text-gray-900">Innovation</h3>
                    <p class="text-gray-500 text-sm mt-2 leading-relaxed">Kami terus mengeksplorasi ide baru dan teknologi
                        mutakhir untuk memberikan keunggulan kompetitif.</p>
                </div>

                {{-- Integrity Card --}}
                <div class="bg-white rounded-2xl p-6 text-center shadow-sm hover:shadow-md transition group">
                    <div
                        class="w-16 h-16 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition duration-300">
                        <i class="fas fa-shield-alt text-white text-2xl"></i>
                    </div>
                    <h3 class="text-xl font-bold text-gray-900">Integrity</h3>
                    <p class="text-gray-500 text-sm mt-2 leading-relaxed">Kami membangun kepercayaan melalui kejujuran dan
                        transparansi dalam setiap hubungan.</p>
                </div>

                {{-- Collaboration Card --}}
                <div class="bg-white rounded-2xl p-6 text-center shadow-sm hover:shadow-md transition group">
                    <div
                        class="w-16 h-16 bg-gradient-to-br from-purple-500 to-pink-500 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition duration-300">
                        <i class="fas fa-handshake text-white text-2xl"></i>
                    </div>
                    <h3 class="text-xl font-bold text-gray-900">Collaboration</h3>
                    <p class="text-gray-500 text-sm mt-2 leading-relaxed">Kami percaya hasil terbaik datang dari kerja sama
                        tim yang solid dengan klien.</p>
                </div>

                {{-- Impact Card --}}
                <div class="bg-white rounded-2xl p-6 text-center shadow-sm hover:shadow-md transition group">
                    <div
                        class="w-16 h-16 bg-gradient-to-br from-amber-500 to-orange-500 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition duration-300">
                        <i class="fas fa-chart-line text-white text-2xl"></i>
                    </div>
                    <h3 class="text-xl font-bold text-gray-900">Impact</h3>
                    <p class="text-gray-500 text-sm mt-2 leading-relaxed">Kami berkomitmen menciptakan nilai yang membuat
                        perbedaan nyata bagi bisnis Anda.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    @if ($services->isNotEmpty())
        <section class="py-20 bg-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-12">
                    <span class="bg-dotech-blue/10 text-dotech-blue text-sm font-semibold px-4 py-1.5 rounded-full">Layanan
                        Kami</span>
                    <h2 class="text-3xl lg:text-4xl font-bold text-gray-900 mt-4">Solusi Digital Yang Kami Tawarkan</h2>
                    <p class="text-gray-600 mt-3 max-w-2xl mx-auto">Teknologi tepat guna untuk mendorong pertumbuhan bisnis
                        Anda</p>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    @foreach ($services as $service)
                        <div
                            class="service-card group bg-gray-50 rounded-xl p-6 hover:bg-white hover:shadow-lg transition-all duration-300">

                            <div class="w-14 h-14 rounded-xl flex items-center justify-center mb-4"
                                style="background-color: {{ ($service->color ?? '#2563EB') . '22' }}; color: {{ $service->color ?? '#2563EB' }}">
    ...
    {{-- @if ($testimonials->isNotEmpty())
        <section class="py-20 bg-gray-50">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-12">
                    <span
                        class="bg-dotech-blue/10 text-dotech-blue text-sm font-semibold px-4 py-1.5 rounded-full">Testimonial</span>
                    <h2 class="text-3xl lg:text-4xl font-bold text-gray-900 mt-4">Apa Kata Klien Kami</h2>
                    <p class="text-gray-600 mt-3 max-w-2xl mx-auto">Kepercayaan klien adalah bukti nyata kualitas layanan
                        kami</p>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    @foreach ($testimonials as $testimonial)
                        <div class="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition">
                            <div class="flex gap-1 mb-4">
                                @for ($i = 1; $i <= 5; $i++)
                                    <i
                                        class="fas fa-star text-xs {{ $i <= $testimonial->rating ? 'text-yellow-400' : 'text-gray-300' }}"></i>
                                @endfor
                            </div>
                            <p class="text-gray-600 text-sm leading-relaxed mb-6 italic">"{{ $testimonial->testimonial }}"
                            </p>
                            <div class="flex items-center gap-3">
                                ...
                                @else
                                    <div
                                        class="w-10 h-10 rounded-full bg-gradient-to-br from-dotech-blue to-blue-400 flex items-center justify-center text-white font-bold">
                                        {{ substr($testimonial->client_name, 0, 1) }}
                                    </div>
                                @endif
                                <div>
                                    <div class="font-semibold text-gray-900 text-sm">{{ $testimonial->client_name }}</div>
                                    <div class="text-xs text-gray-400">{{ $testimonial->position }}@if ($testimonial->company_name)
    ...
    <section class="py-16 bg-gradient-to-r from-dotech-blue to-blue-700 text-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            @else
                <div class="flex flex-wrap justify-center gap-4 mb-8">
                    <a href="#"
                        class="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center hover:bg-white hover:text-dotech-blue transition">
            ...
            <a href="{{ route('contact') }}"
                class="inline-block bg-white text-dotech-blue font-semibold px-8 py-3.5 rounded-xl hover:bg-blue-50 transition-colors">
                Hubungi Kami →
            </a>
        </div>
    </section>
