    ...
    <div class="relative bg-gradient-to-br from-dotech-dark via-blue-900 to-blue-950 text-white overflow-hidden">
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28">
            <div class="text-center">
                {{-- Animated Badge --}}
                <div class="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-4 py-1.5 mb-6 animate-slide-down">
                ...
                <h1 class="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-extrabold text-white leading-tight mb-6 animate-fade-in-up">
                    <span class="bg-gradient-to-r from-blue-400 via-cyan-400 to-blue-500 bg-clip-text text-transparent">Hubungi</span> Kami
                </h1>

                <p class="text-lg md:text-xl text-blue-100 max-w-2xl mx-auto leading-relaxed animate-fade-in-up animation-delay-200">
                    Kami siap membantu mewujudkan ide digital Anda menjadi kenyataan. Konsultasikan kebutuhan Anda sekarang!
                </p>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div class="grid grid-cols-1 lg:grid-cols-5 gap-12">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                <label class="form-label block text-sm font-semibold text-gray-700 mb-1">
                                    <i class="fas fa-user text-gray-400 mr-1"></i> Nama <span class="text-red-500">*</span>
                                </label>
                            ...
                            <div>
                                ...
                                @error('phone')<p class="form-error text-red-500 text-xs mt-1">{{ $message }}</p>@enderror
                            </div>
                        </div>
                        <div>
                            <label class="form-label block text-sm font-semibold text-gray-700 mb-1">
                            ...
                            @error('email')<p class="form-error text-red-500 text-xs mt-1">{{ $message }}</p>@enderror
                        </div>
                        <div>
                            <label class="form-label block text-sm font-semibold text-gray-700 mb-1">
                                <i class="fas fa-tag text-gray-400 mr-1"></i> Subjek <span class="text-red-500">*</span>
                            </label>
                            ...
                            @error('subject')<p class="form-error text-red-500 text-xs mt-1">{{ $message }}</p>@enderror
                        </div>
                        <div>
                            <label class="form-label block text-sm font-semibold text-gray-700 mb-1">
                            ...
                            @error('message')<p class="form-error text-red-500 text-xs mt-1">{{ $message }}</p>@enderror
                        </div>
                        <button type="submit" class="btn-primary w-full justify-center py-3.5 flex items-center gap-2 text-base font-semibold group">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 hover:shadow-xl transition">
                    ...
                    <div class="space-y-5">
                        ...
                        <div class="flex gap-4 items-start group">
                            <div class="w-11 h-11 bg-blue-50 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:bg-dotech-blue transition-colors duration-300">
                                <i class="fas fa-envelope text-dotech-blue text-lg group-hover:text-white transition-colors"></i>
                            </div>
                            <div>
                                <p class="font-semibold text-gray-800 text-sm">Email</p>
                                <a href="mailto:{{ $contact->email }}" class="text-dotech-blue text-sm hover:underline break-all">{{ $contact->email }}</a>
                            </div>
                        </div>
                        @endif
                        ...
                        @if($contact->whatsapp)
                        <div class="flex gap-4 items-start group">
                            <div class="w-11 h-11 bg-green-50 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:bg-green-500 transition-colors duration-300">
                                <i class="fab fa-whatsapp text-green-600 text-lg group-hover:text-white transition-colors"></i>
                            </div>
                            <div>
                        ...
                        <div class="flex gap-4 items-start group">
                            <div class="w-11 h-11 bg-blue-50 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:bg-dotech-blue transition-colors duration-300">
                                <i class="fas fa-phone-alt text-dotech-blue text-lg group-hover:text-white transition-colors"></i>
                            </div>
                            <div>
                                <p class="font-semibold text-gray-800 text-sm">Telepon</p>
                                <a href="tel:{{ $contact->phone }}" class="text-gray-600 text-sm hover:text-dotech-blue">{{ $contact->phone }}</a>
                            </div>
                        </div>
                        @endif
                        ...
                        @if($contact->address)
                        <div class="flex gap-4 items-start group">
                            <div class="w-11 h-11 bg-red-50 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:bg-red-500 transition-colors duration-300">
                                <i class="fas fa-map-marker-alt text-red-500 text-lg group-hover:text-white transition-colors"></i>
                            </div>
                            <div>
                        ...
                        <div class="flex gap-4 items-start group">
                            <div class="w-11 h-11 bg-purple-50 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:bg-purple-500 transition-colors duration-300">
                                <i class="fas fa-clock text-purple-500 text-lg group-hover:text-white transition-colors"></i>
                            </div>
                            <div>
                ...
                <div class="rounded-2xl overflow-hidden shadow-lg border border-gray-100 hover:shadow-xl transition">
                ...
                {{-- FAQ Quick Link Card --}}
                <div class="bg-gradient-to-br from-gray-50 to-white rounded-2xl shadow-lg border border-gray-100 p-6 hover:shadow-xl transition">
                    <div class="flex items-center gap-3 mb-4 pb-3 border-b border-gray-100">
                    ...
                    <p class="text-gray-500 text-sm mb-4">Kunjungi halaman FAQ untuk pertanyaan yang sering diajukan seputar layanan kami.</p>
                    <a href="{{ route('home') ?? '#' }}" class="inline-flex items-center gap-2 text-dotech-blue text-sm font-medium hover:gap-3 transition-all group">
                        <span>Lihat FAQ</span>
                ...
                {{-- Quick Response Card --}}
                <div class="bg-gradient-to-r from-dotech-blue to-blue-700 text-white rounded-2xl p-6 text-center hover:shadow-xl transition transform hover:-translate-y-1">
                    ...
                    <p class="text-blue-100 text-sm leading-relaxed">Tim kami akan merespon pesan Anda dalam <strong class="font-bold">kurang dari 24 jam kerja</strong></p>
