...
<div class="max-w-7xl mx-auto px-4 sm:px-0">
    <form method="POST" action="{{ route('admin.testimonials.store') }}" enctype="multipart/form-data" class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold bg-gradient-to-r from-gray-900 to-gray-600 bg-clip-text text-transparent">Tambah Testimonial Baru</h1>
                <p class="text-sm text-gray-500 mt-1">Tambahkan testimonial dari klien yang puas dengan layanan Anda</p>
            </div>
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <label class="flex flex-col items-center justify-center w-full h-48 border-2 border-dashed border-gray-200 rounded-xl cursor-pointer hover:border-indigo-500 hover:bg-indigo-50/20 transition-all duration-200 bg-gray-50/30" id="photoLabel">
                                ...
                                <span class="text-sm text-gray-500 font-medium">Klik untuk upload foto</span>
