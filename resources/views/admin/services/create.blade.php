...
@section('content')
    <div class="max-w-7xl mx-auto px-4 sm:px-0">
        <form method="POST" action="{{ route('admin.services.store') }}" class="space-y-6" autocomplete="off">
            @csrf
                            ...
                            <div class="relative" id="iconPickerContainer">
                                <div class="flex items-center gap-2">
                                    ...
                                    <div class="w-[50px] h-[50px] flex items-center justify-center bg-gray-50 border border-gray-200 rounded-xl text-xl text-gray-700"
                                        id="smallIconPreview">
                                        <i class="{{ old('icon', 'fas fa-cogs') }}"></i>
                                    </div>
                                </div>
                        ...
                        <div
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <label for="is_featured"
                                    class="text-sm font-medium text-gray-700 cursor-pointer">Tampilkan sebagai
                                    Featured</label>
                            </div>
                    ...
                    <div
                        ...
                        <div class="p-4 bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl" id="previewCard">
                            <div class="text-center space-y-3">
                                <div class="text-5xl text-blue-600" id="previewIcon"><i
                                        class="{{ old('icon') ?: 'fas fa-cogs' }}"></i></div>
                                <h4 class="font-bold text-gray-800" id="previewTitle">
                                    {{ old('title') ?: 'Judul Layanan' }}</h4>
                                <p class="text-sm text-gray-600 line-clamp-3" id="previewDescription">
                                    {{ old('description') ?: 'Deskripsi layanan akan muncul di sini...' }}</p>
                            </div>
                        </div>
    ...
    @push('scripts')
        <script>
            ...
            function updatePreview() {
                previewTitle.textContent = titleInput.value || 'Judul Layanan';
                previewDescription.textContent = descriptionInput.value || 'Deskripsi layanan akan muncul di sini...';
            ...
            // Koleksi Ikon FontAwesome (Bisa ditambahkan sesuai kebutuhan)
            const faIcons = [
