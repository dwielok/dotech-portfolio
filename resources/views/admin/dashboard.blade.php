        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            <div
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div
                        class="w-12 h-12 bg-emerald-100 rounded-xl flex items-center justify-center group-hover:bg-emerald-500 group-hover:scale-110 transition-all duration-300">
            ...
            <div
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div
                        class="w-12 h-12 bg-amber-100 rounded-xl flex items-center justify-center group-hover:bg-amber-500 group-hover:scale-110 transition-all duration-300">
                    ...
                    <div>
                        ...
                        @if ($stats['unread_messages'] > 0)
                            <div class="flex items-center gap-1 mt-2">
                                ...
                                <p class="text-xs text-red-600 font-semibold">{{ $stats['unread_messages'] }} belum dibaca
                                </p>
                            </div>
                        @else
                            <div class="flex items-center gap-1 mt-2">
                ...
                <div class="divide-y divide-gray-50">
                    @forelse($recentMessages as $msg)
                        <a href="{{ route('admin.messages.show', $msg) }}"
                            ...
                            <div
                                class="w-10 h-10 rounded-xl bg-gradient-to-br from-dotech-blue to-blue-600 text-white flex items-center justify-center text-sm font-bold flex-shrink-0 shadow-sm">
                            ...
                            <i
                                class="fas fa-chevron-right text-gray-300 text-sm group-hover:text-dotech-blue group-hover:translate-x-1 transition-all"></i>
                        </a>
                    @empty
                ...
                <div class="divide-y divide-gray-50">
                    @forelse($recentProjects as $project)
                        <div class="flex items-center gap-3 px-6 py-4 hover:bg-gray-50 transition-colors group">
                            ...
                            <div class="flex-1 min-w-0">
                                <p
                                    class="font-semibold text-sm text-gray-800 truncate group-hover:text-dotech-blue transition">
                                    {{ $project->title }}</p>
                                <div class="flex items-center gap-2 mt-1">
                                    <i class="fas fa-calendar-alt text-gray-300 text-xs"></i>
                                    <p class="text-xs text-gray-400">
                                        {{ $project->created_at ? $project->created_at->format('d M Y') : '-' }}</p>
                                </div>
                            </div>
                            <div class="flex items-center gap-2">
                                <span
                                    class="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-medium {{ $project->status === 'published' ? 'bg-green-100 text-green-700' : 'bg-yellow-100 text-yellow-700' }}">
                                    <i
                                        class="fas {{ $project->status === 'published' ? 'fa-check-circle' : 'fa-pen' }} text-xs"></i>
        ...
        <div class="bg-gradient-to-br from-gray-50 to-white rounded-2xl shadow-sm border border-gray-100 p-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                <a href="{{ route('admin.projects.create') }}"
                    class="group flex flex-col items-center gap-2 p-4 bg-white rounded-xl border border-gray-100 hover:border-dotech-blue hover:shadow-md transition-all duration-300">
                    <div
                        class="w-12 h-12 bg-blue-50 rounded-xl flex items-center justify-center group-hover:bg-blue-500 transition-colors">
                ...
                <a href="{{ route('admin.services.create') }}"
                    class="group flex flex-col items-center gap-2 p-4 bg-white rounded-xl border border-gray-100 hover:border-dotech-blue hover:shadow-md transition-all duration-300">
                    <div
                        class="w-12 h-12 bg-emerald-50 rounded-xl flex items-center justify-center group-hover:bg-emerald-500 transition-colors">
                ...
                <a href="{{ route('admin.testimonials.create') }}"
                    class="group flex flex-col items-center gap-2 p-4 bg-white rounded-xl border border-gray-100 hover:border-dotech-blue hover:shadow-md transition-all duration-300">
                    <div
                        class="w-12 h-12 bg-amber-50 rounded-xl flex items-center justify-center group-hover:bg-amber-500 transition-colors">
                ...
                <a href="{{ route('admin.messages.index') }}"
                    class="group flex flex-col items-center gap-2 p-4 bg-white rounded-xl border border-gray-100 hover:border-dotech-blue hover:shadow-md transition-all duration-300">
                    <div
                        class="w-12 h-12 bg-red-50 rounded-xl flex items-center justify-center group-hover:bg-red-500 transition-colors">
