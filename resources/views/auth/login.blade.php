...
<x-guest-layout>
    {{--
        ============================================================================
        LOGIN PAGE - DOTECH DIGITAL STYLE (SPLIT LAYOUT)
        ============================================================================
        This login page features a split layout with:
        ...
        <div class="hidden lg:flex lg:w-1/2 relative items-center justify-center px-12">
            <div class="max-w-lg animate-fade-in-left animation-delay-100">
                ...
                <p class="text-gray-300 text-lg leading-relaxed mb-8">
                    Access your dashboard and continue your journey with Indonesia's trusted digital solution partner.
                </p>
                ...
                <div
                    ...
                    <div class="bg-white/5 backdrop-blur-sm p-6 sm:p-8">
                        ...
                        <div class="text-center mb-8">
                            ...
                            <p class="text-gray-400 text-sm">Access your account dashboard</p>
                        ...
                        <form method="POST" action="{{ route('login') }}" class="space-y-6">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input id="email" type="email" name="email" value="{{ old('email') }}"
                                        ...
                                        class="login-input w-full pl-10 pr-3 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all"
                            ...
                            <div>
                                <label for="password" class="block text-sm font-medium text-gray-300 mb-2">
                                    <i class="fas fa-lock text-blue-400 text-xs mr-1"></i>
                                    Password
                                </label>
                                <div class="relative">
                                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            ...
                            <div class="flex items-center justify-between">
                                <label class="flex items-center cursor-pointer group">
                                    <input type="checkbox" name="remember" id="remember_me"
                                        class="rounded border-gray-600 bg-white/5 text-blue-600 focus:ring-blue-500 focus:ring-offset-0 cursor-pointer">
                                    <span
                                        class="ms-2 text-sm text-gray-400 group-hover:text-gray-300 transition-colors">
                                        Remember me
                                    </span>
                                </label>
                            ...
                            <div>
                                <button type="submit"
                                    class="login-submit-btn w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-500 hover:to-blue-600 text-white font-semibold py-3 px-4 rounded-xl transition-all duration-300 shadow-lg hover:shadow-blue-500/25 flex items-center justify-center gap-2 group">
                                    <i
                                        class="fas fa-sign-in-alt text-sm group-hover:translate-x-0.5 transition-transform"></i>
                                    <span>Sign In</span>
                                    <i
