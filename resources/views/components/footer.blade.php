...
<footer class="bg-gradient-to-br from-dotech-dark via-blue-950 to-dotech-dark text-white">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
            ...
            <div class="lg:col-span-2">
                ...
                <div class="flex items-center gap-2 mb-4">
                    ...
                    <span
                        class="text-xl font-bold bg-gradient-to-r from-white to-blue-300 bg-clip-text text-transparent">Dotech
                        Digital</span>
                </div>
                {{-- @endif --}}
                <p class="text-gray-400 leading-relaxed mb-5 text-sm max-w-md">
                    Solusi teknologi digital terpercaya untuk bisnis Anda. Web Development, Mobile App, Cloud Solution,
                    dan IT Consulting.
                </p>
                <div class="flex flex-wrap items-center gap-2 text-xs text-gray-500 mb-4">
                    <span class="flex items-center gap-1"><i class="fas fa-check-circle text-green-500 text-xs"></i>
                        150+ Klien</span>
                    <span class="w-1 h-1 bg-gray-600 rounded-full"></span>
                    <span class="flex items-center gap-1"><i class="fas fa-check-circle text-green-500 text-xs"></i> 8+
                        Tahun</span>
                    <span class="w-1 h-1 bg-gray-600 rounded-full"></span>
                    <span class="flex items-center gap-1"><i class="fas fa-check-circle text-green-500 text-xs"></i>
                        250+ Proyek</span>
                ...
                @else
                    <div class="flex
                                        gap-2">
                        <a href="#"
                            class="w-9 h-9 rounded-lg bg-white/5 hover:bg-dotech-blue hover:scale-110 flex items-center justify-center transition-all">
            ...
            <div>
                ...
                <ul class="space-y-2.5">
                    @foreach ($services as $service)
                        <li>
                            <a href="{{ route('about') }}#services"
                                class="text-gray-400 hover:text-dotech-blue transition-colors text-sm flex items-center gap-2 group">
                                <i
                                    class="fas fa-chevron-right text-[10px] text-gray-500 group-hover:text-dotech-blue transition"></i>
                                {{ $service->title }}
                            </a>
                        </li>
                    @endforeach
                    @if ($services->isEmpty())
                        <li><a href="#"
                                class="text-gray-400 hover:text-dotech-blue text-sm flex items-center gap-2"><i
                                    class="fas fa-chevron-right text-[10px]"></i> Web Development</a></li>
                        <li><a href="#"
                                class="text-gray-400 hover:text-dotech-blue text-sm flex items-center gap-2"><i
                                    class="fas fa-chevron-right text-[10px]"></i> Mobile Apps</a></li>
                        <li><a href="#"
                                class="text-gray-400 hover:text-dotech-blue text-sm flex items-center gap-2"><i
                                    class="fas fa-chevron-right text-[10px]"></i> Cloud Solutions</a></li>
                        <li><a href="#"
                                class="text-gray-400 hover:text-dotech-blue text-sm flex items-center gap-2"><i
                                    class="fas fa-chevron-right text-[10px]"></i> IT Consulting</a></li>
                    @endif
                </ul>
            </div>
            ...
            <div>
                            ...
                            <li class="flex gap-3 items-start">
                                ...
                                <div>
                                    ...
                                    <a href="mailto:{{ $contact->email }}"
                                        class="text-gray-400 hover:text-dotech-blue transition">{{ $contact->email }}</a>
                                </div>
                            </li>
                        @endif
                        @if ($contact->whatsapp)
                            <li class="flex gap-3 items-start">
                                ...
                                <div>
                                    ...
                                    <a href="{{ $contact->whatsapp_url }}" target="_blank"
                                        class="text-gray-400 hover:text-green-400 transition">{{ $contact->whatsapp }}</a>
                                </div>
                            </li>
                        @endif
                        @if ($contact->phone)
                            <li class="flex gap-3 items-start">
                                ...
                                <div>
                                    ...
                                    <a href="tel:{{ $contact->phone }}"
                                        class="text-gray-400 hover:text-dotech-blue transition">{{ $contact->phone }}</a>
                                </div>
                            </li>
                        @endif
                        @if ($contact->address)
                ...
                @else
                    <ul class="space-y-3 text-sm">
                        <li class="flex gap-3"><i class="fas fa-envelope text-dotech-blue"></i><a
                                href="mailto:hello@dotech.com"
                                class="text-gray-400 hover:text-dotech-blue">hello@dotech.com</a></li>
                        <li class="flex gap-3"><i class="fab fa-whatsapp text-green-400"></i><a href="#"
                                class="text-gray-400 hover:text-green-400">+62 812 3456 7890</a></li>
                        <li class="flex gap-3"><i class="fas fa-map-marker-alt text-red-400"></i><span
                                class="text-gray-400">Jakarta, Indonesia</span></li>
                    </ul>
                @endif
            </div>
        </div>
    ...
    <div class="border-t border-white/10">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="flex flex-col md:flex-row justify-between items-center gap-6">
                ...
                <div class="flex flex-col sm:flex-row items-center gap-3">
                    ...
                    <form action="{{ route('home') ?? '#' }}" method="POST" class="flex">
                        ...
                        <button type="submit"
                            class="bg-dotech-blue hover:bg-blue-700 rounded-r-lg px-3 py-1.5 text-sm transition">
            ...
            {{-- Legal Links --}}
            <div
                class="flex flex-wrap justify-center md:justify-between items-center gap-4 mt-5 pt-5 border-t border-white/5 text-xs text-gray-500">
                <div class="flex gap-4">
                    <a href="{{ route('privacy') }}"
                        class="hover:text-dotech-blue transition flex items-center gap-1">
...
{{-- Back to Top Button --}}
<button id="backToTop"
    class="fixed bottom-6 right-6 w-11 h-11 bg-dotech-blue hover:bg-blue-700 rounded-full shadow-lg flex items-center justify-center text-white transition-all duration-300 opacity-0 invisible hover:scale-110 z-40">
